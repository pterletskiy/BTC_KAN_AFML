...
% per-split is 1.9 observations, and average embargoed-per-split is
% 16.5 observations. Per-group sample size is 146 events (uniform
% across all 8 groups). Group date ranges span 2015-08-08 (G0) to
% 2026-05-02 (G7). Zero leakage detected across all 28 splits.
%
